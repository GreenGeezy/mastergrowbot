...
- NEVER reference specific AI model names in grow guide articles, page copy, or any user-facing content. This includes (but is not limited to): Gemini 3.1 Pro, Gemini 3 Pro, Google's Gemini, Claude Sonnet, Claude Opus, GPT-4, GPT-4o, ChatGPT, OpenAI, Google DeepMind, or any other specific model or vendor names. Instead, always use generic brand-aligned descriptions such as: "the most powerful, capable, and advanced AI models customized and trained specifically for growing and cultivation", "advanced AI models built on vast custom data sets from the world's leading cannabis growing and plant science methods and research", or "our proprietary cannabis cultivation AI". This rule applies to all rendered content including intro paragraphs, section bodies, comparison tables, CTAs, and short descriptions. It does NOT apply to FAQ answers (not rendered) or code logic.
