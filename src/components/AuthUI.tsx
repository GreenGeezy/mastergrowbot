  ...
  return <div className="w-full max-w-3xl mx-auto">
      <Card className="border border-primary/20">
        <CardHeader className="space-y-1 px-6 py-4">
          ...
          <div className="flex items-center justify-center flex-col mt-2 w-full">
            <p className="text-center font-semibold text-xl mb-2 cursor-pointer hover:underline" onClick={handleSquareSubscription}>
              Subscribe with Square Secure Checkout
            </p>
            <img 
              ...
              className="w-1/4 object-contain cursor-pointer hover:opacity-90 transition-opacity" 
            />
          </div>
        </CardHeader>
        <CardContent>
