        ...
        <CardContent>
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <Button 
              ...
              onClick={!hasValidToken ? handleDisabledButtonClick : undefined}
            >
            ...
            <Button
              ...
              onClick={hasValidToken ? handleGoogleSignIn : handleDisabledButtonClick}
              disabled={loading || !hasValidToken}
            >
            ...
            <div className="text-center mt-4">
              <button
                ...
                onClick={hasValidToken ? handleToggleMode : handleDisabledButtonClick}
