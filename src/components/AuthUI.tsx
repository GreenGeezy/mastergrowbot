  ...
  return <div className="w-full max-w-md mx-auto">
      <Card className="border border-primary/20">
        <CardHeader className="space-y-1">
          ...
          <p className="text-center font-medium text-primary pt-2">Subscribe with Square</p>
        ...
        <CardContent>
          <form onSubmit={handleAuth} className="space-y-4">
            ...
            <Button type="submit" className="w-full" disabled={loading || !hasValidToken} onClick={!hasValidToken ? handleDisabledButtonClick : undefined}>
            ...
            <Button type="button" variant="outline" className="w-full flex items-center justify-center gap-2" onClick={hasValidToken ? handleGoogleSignIn : handleDisabledButtonClick} disabled={loading || !hasValidToken}>
            ...
            <div className="text-center mt-4">
              <button type="button" className="text-sm text-gray-400 hover:text-white" onClick={hasValidToken ? handleToggleMode : handleDisabledButtonClick} disabled={!hasValidToken}>
