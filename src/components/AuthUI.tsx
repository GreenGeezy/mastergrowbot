      ...
      <Card className="border border-primary/20">
        <CardHeader className="space-y-1">
          ...
          <div className="flex items-center justify-center gap-4 mt-3 my-[2px] w-full">
            <img src="/lovable-uploads/385ffa4e-201d-40f2-9b65-0003aa856b7b.png" alt="Square secure checkout with payment options" onClick={handleSquareSubscription} className="h-[50%] w-full object-cover cursor-pointer hover:opacity-90 transition-opacity" />
          </div>
        </CardHeader>
        <CardContent>
