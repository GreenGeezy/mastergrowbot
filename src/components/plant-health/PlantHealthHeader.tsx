...
const PlantHealthHeader = () => {
  return <div className="text-center mb-8 animate-fade-in bg-white">
      ...
      <p className="text-gray-600">Take a pic or Upload images of your plant fora customized instant AI-powered health analysis with Recommended Actions to grow bigger better buds!</p>
    </div>;
};
