...
export const ChatHeader = () => {
  ...
  return (
    <>
      <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-4 border-b border-[#333333] bg-[#1A1A1A] h-[72px]">
        ...
        <div className="flex items-center space-x-2">
          ...
          <Link to="/">
            <Button 
              variant="outline"
              className="bg-white hover:bg-gray-100 text-gray-800 font-semibold border border-gray-400 rounded-lg shadow-sm"
            >
              Sign In / Register
            </Button>
          </Link>
