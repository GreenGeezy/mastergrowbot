      ...
      <div className="w-full max-w-md">
        <Card className="border border-primary/20">
          ...
          <CardContent className="space-y-4">
            <p className="text-center text-muted-foreground">Thank you for your purchase! Enter your Email and Password and Click the Sign Up button or Click the Sign in with Google Butbutton below to set up your account. Please be sure to use the same email address or Google Account (gmail) you used for your purchase:</p>

            <AuthForm email={email} password={password} loading={loading} showPassword={showPassword} isSignUp={true} onEmailChange={setEmail} onPasswordChange={setPassword} onTogglePassword={() => setShowPassword(!showPassword)} onSubmit={handleAuth} onToggleMode={() => {}} // Disabled for this flow
