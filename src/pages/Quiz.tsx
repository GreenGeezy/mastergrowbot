                      ...
                      <div className="bg-gradient-to-br from-green-600/20 to-green-800/20 border border-green-500/30 rounded-xl p-6 backdrop-blur-sm">
                        <div className="flex items-start space-x-4">
                          <div className="bg-green-500/20 p-3 rounded-lg">
                            <img src="/lovable-uploads/4b8e7f0e-6e5c-45e6-9007-a2b8a1addd41.png" alt="Cannabis plant" className="w-24 h-24 object-contain" />
                          </div>
                      ...
                      <div className="bg-gradient-to-br from-yellow-600/20 to-orange-600/20 border border-yellow-500/30 rounded-xl p-6 backdrop-blur-sm">
                        <div className="flex items-start space-x-4">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-yellow-600 dark:text-yellow-400 text-sm font-medium">Gain confidence with custom scans and personalized action to maximize your cultivation's value and revenue</p>
                          </div>
                        </div>
                      </div>
