    ...
    return <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4 circuit-background">
        <div className="w-full max-w-[1200px] space-y-8">
          ...
          <div className="flex flex-row gap-4 items-stretch justify-center flex-wrap md:flex-nowrap mb-8">
            ...
            <div className="w-[259px] flex flex-col font-['Rubik'] bg-card rounded-lg overflow-hidden">
              ...
              <div className="p-5 flex flex-col flex-grow">
                <div className="min-h-[76px] my-0">
                  <h3 className="leading-[24px] font-bold text-white my-[69px] text-xl">
                    Master Growbot AI Quarterly Subscription
                  </h3>
                </div>
                <p className="leading-[24px] text-white/80 mb-4 font-bold mx-[37px] text-xl my-0">$89 (Save 25%) Cancel Anytime</p>
            ...
            <div className="w-[259px] flex flex-col font-['Rubik'] bg-card rounded-lg overflow-hidden">
              <div className="aspect-w-16 aspect-h-9 overflow-hidden">
                <img src="https://items-images-production.s3.us-west-2.amazonaws.com/files/f79453c5b8c01e6fe4805b6ac378f6e2568cc993/original.png" alt="Master Growbot AI Yearly Subscription" className="w-full h-full object-cover" onError={e => {
                const target = e.target as HTMLImageElement;
                target.style.display = 'none';
              }} />
              </div>
